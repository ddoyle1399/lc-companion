...
export default function CompositionPage() {
  ...
  function handleDownloadMarkdown() {
    const filename = `${compositionTypeLabels[compositionType]} Guide - ${level} ${year}.md`;
  ...
  async function handleDownloadWord() {
    const filename = `${compositionTypeLabels[compositionType]} Guide - ${level} ${year}`;
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 no-print">
          <h1 className="text-2xl font-semibold text-navy">
            Composition Guide Generator
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Generate writing guides for Paper 1 compositions. Worth 100 marks, assessed on PCLM.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5 mb-6 no-print">
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              placeholder='e.g., "Focus on opening strategies", "Include a sample on the topic of identity"'
            />
          </div>
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200 no-print">
              <div>
                <h2 className="font-medium text-navy text-sm">
                  {compositionTypeLabels[compositionType]} &ndash; {level} {year}
                </h2>
                {generating && (

...
export default function UnseenPoetryPage() {
  ...
  function handleDownloadMarkdown() {
    const filename = `Unseen Poetry Guide - ${level} ${year}.md`;
  ...
  async function handleDownloadWord() {
    const filename = `Unseen Poetry Guide - ${level} ${year}`;
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 no-print">
          <h1 className="text-2xl font-semibold text-navy">
            Unseen Poetry Guide Generator
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Generate skills-based guides for tackling unseen poetry in Paper 2, Section III.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5 mb-6 no-print">
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              placeholder='e.g., "Focus on imagery techniques", "Include more practice exercises"'
            />
          </div>
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200 no-print">
              <div>
                <h2 className="font-medium text-navy text-sm">
                  Unseen Poetry Guide &ndash; {level} {year}
                </h2>
                {generating && (
